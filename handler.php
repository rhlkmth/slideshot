...
try {
	...
	$mail_from_last_name = isset( $_POST['lastname'] ) ? $_POST['lastname'] : '';
	...
	$mail_linkedin = isset( $_POST['linkedin'] ) ? $_POST['linkedin'] : '';
	$mail_portfolio = isset( $_POST['portfolio'] ) ? $_POST[''] : '';
	...
	$mail->Body = '
		...
		<strong>Last Name:</strong> ' . $mail_from_last_name . '<br>
		<strong>Email:</strong> ' . $mail_from_email . '<br>
		<strong>Phone:</strong> ' . $mail_phone . '<br>
		<strong>Company:</strong> ' . $mail_company . '<br>
		<strong>LinkedIn:</strong> ' . $mail_linkedin . '<br>
		<strong>Portfolio:</strong> ' . $mail_portfolio . '<br>
